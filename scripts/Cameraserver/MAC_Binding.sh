...
echo "$Machine_ID,Mac_Binding,Failed" >> /root/scripts/Cameraserver/Failed_Details/Mac_Binding.csv
echo "$Machine_ID,Mac_Binding,Failed" >> /root/scripts/Cameraserver/Failed_Details/testMac_Binding.csv
fi
...
if [ -e /root/scripts/Cameraserver/Failed_Details/Mac_Binding.csv ]
then
...
done < /root/scripts/Cameraserver/Failed_Details/Mac_Binding.csv

rm -rf /root/scripts/Cameraserver/Failed_Details/Mac_Binding.csv
