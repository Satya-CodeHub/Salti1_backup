#!/bin/bash
Master_Path="/root/scripts/Chiller_Alert"
...
if [ -z "$(ls -A /root/scripts/Chiller_Alert/Machine_Name)" ]; then

   echo "Not Issue Found,Hence Sending No Issue Mail"
   echo "Team All Looks Good! No Issue Found In Temprature Check." | mutt -s "Chiller Alert V2-Machines" surendran.a@bigbasket.com
   exit 0
...
mutt -e "set content_type=text/html" -s "Chiller Alert V2-Machines" bbinstant.techops@bigbasket.com,bbiblrfe@bigbasket.com,bbincrfe@bigbasket.com,bbihydfe@bigbasket.com,bbimumfe@bigbasket.com,bbipunfe@bigbasket.com -c sunil.kumarb@bigbasket.com,vivek.pandey@bigbasket.com,pranjal.kelkar@bigbasket.com,ankur.raina@bigbasket.com,hasean.n@bigbasket.com,abhishek.dhakare@bigbasket.com,kumud.narang@bigbasket.com </root/scripts/Chiller_Alert/chiller.html
